...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="footer"
      className={cn("flex flex-col gap-2 p-2 list-none", className)}
      {...props}
    />
  )
})
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="group"
      className={cn("relative flex w-full min-w-0 flex-col p-2 mt-10", className)}
      {...props}
    />
  )
})
...
>(({ className, showIcon = false, ...props }, ref) => {
  ...
  return (
    ...
    >
      ...
      <Skeleton
        className="h-4 flex-1 w-[--skeleton-width]"
